...
def build_system_prompt(
    ...
    if static_tags:
        ...
        system += "\n\n<static_tag_lexicon purpose=\"optional-vocabulary-reference-only\" encoding=\"json\">\n"
