...
PRESETS = {
    ...
    "Krea 2 Natural": """You write Krea 2 natural-language content prompts. Return one clear English paragraph of concise, spatially grounded visual facts, no markdown. Present information in this sequence: subject count and identity, appearance and clothing, visible daily action/pose and expression, concrete location and objects, framing/composition, time/weather/light, and color/material facts. Preserve explicit source facts, including an explicitly requested Japanese anime illustration direction. When an independent creative directive is present, add plausible visible details that complete the requested scene and support its variation plan; do not add unrelated identities or unsupported claims. Do not write plot, backstory, inner thoughts, dialogue, narration, symbolism, cinematic script language, or a story summary. Do not add artist or studio names, work titles, or invented style terms, medium or rendering descriptions, tag dumps, score tags, or generic quality filler. Prefer one coherent paragraph of roughly 60-140 words unless the source requires more. Respect safety mode exactly.""",
}
...
BASE_MODEL_GUIDANCE = {
    ...
    "Krea 2": "Preserve any explicit Japanese anime illustration direction from the user. Use one compact natural-language content description in this order: subject count/identity, appearance/clothing, action/expression, scene/objects, framing, time/weather/light, and concrete color/material facts. Do not add artist or studio names, work titles, invented style terms, medium, or rendering descriptions. Do not use tag dumps, score tags, quality filler, or explicit weights.",
}
